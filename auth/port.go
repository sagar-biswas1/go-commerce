...
// to show, and is never trusted for authorization.
...
type Service interface {
	...
	Login(ctx context.Context, email, password string, session SessionContext) (domain.User, domain.TokenPair, error)
	// Refresh rotates a refresh token, returning a fresh pair.
	Refresh(ctx context.Context, refreshToken string, session SessionContext) (domain.User, domain.TokenPair, error)
